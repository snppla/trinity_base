...
RUN apt-get update && \
 ...
 openssl mysql-client libboost-system1.55.0 libboost-filesystem1.55.0 libboost-thread1.55.0 libboost-program-options1.55.0 libboost-iostreams1.55.0 libmysqlclient18
